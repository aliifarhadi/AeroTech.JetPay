...
namespace AeroTech.Messages.LedgerFlow.Enums
{
    public enum AccountPurpose
    {
        ...
        [Display(Name = "Wallet Top-Up PSP Clearing")] WalletTopUpPspClearing,
        [Display(Name = "Wallet Top-Up Bank Clearing")] WalletTopUpBankClearing,
        [Display(Name = "Wallet Top-Up Cash On Hand")] WalletTopUpCashOnHand,
        [Display(Name = "Wallet Top-Up Acquirer Clearing")] WalletTopUpAcquirerClearing,
        ...
        [Display(Name = "Refundable Security Deposit Liability")] RefundableSecurityDepositLiability,
        [Display(Name = "Security Deposit Claim Clearing")] SecurityDepositClaimClearing,
        [Display(Name = "Deposit Release Clearing")] DepositReleaseClearing
    }
}
