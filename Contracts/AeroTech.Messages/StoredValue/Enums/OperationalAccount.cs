...
namespace AeroTech.Messages.StoredValue.Enums
{
    public enum OperationalAccount
    {
       ...
       [Display(Name = "Customer Blocked")] CustomerBlocked = 9,
       [Display(Name = "Deposit Claim Clearing")] DepositClaimClearing = 10,
       [Display(Name = "Deposit Release Clearing")] DepositReleaseClearing = 11
    }
}
